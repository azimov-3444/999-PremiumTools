            ...
            <div className="container mx-auto px-4">
                <div className="relative h-[400px] md:h-[500px] rounded-2xl shadow-lg overflow-hidden group">
                    {items.map((slide, index) => {
                        const title = getLocalizedContent(slide, 'title');
                        const description = getLocalizedContent(slide, 'description');
                        const buttonText = getLocalizedContent(slide, 'buttonText');
